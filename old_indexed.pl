...
<html>
  ...
  <body>
<div style="font-size: small">(c) CHORNY (Alexandr Ciornii) 2014. Fork here <a href="https://github.com/chorny/cpan-indexed-old">https://github.com/chorny/cpan-indexed-old</a>.
</div><br><br>
  <%= content %>
  </body>
</html>
